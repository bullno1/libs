// Modified from: https://raw.githubusercontent.com/skeeto/scratch/master/parsers/qoi.c
...
unsigned qoidecode(struct qoidecoder *q);
...
int qoiencode(struct qoiencoder *q, void *buf, unsigned c);
...
int qoifinish(struct qoiencoder *q, void *buf);
